...
## Aan de slag - Deel 2
Nadat ik de individuen geïdentificeerd heb die vanwege hun ethnische achtergrond niet aan deze studie mee kunnen doen, kunnen jullie verder met de kwaliteits controle. Jullie krijgen van mij een lijst net als `example_individu_exclusie.txt`, waaraan ik de individuen heb toegevoegd die eruit gehaald moeten worden.
